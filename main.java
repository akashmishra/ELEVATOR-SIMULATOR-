...
public class main extends Applet implements Runnable {
	...
	public void assignfromouter(int f, char d) {
	...
	public void paint(Graphics g)// automatically get called after init()only once then repaint;
        {
		try {
			...
			// e.fillRect(100,495,30,40);
			// g.drawRect(100, 495, 30, 40);
			// lift_moveup(, 2, e);
			for (int i = 1; i <= 4; i++) {
				e[i - 1].paint(g, i);
			}
